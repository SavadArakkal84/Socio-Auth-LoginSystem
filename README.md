## Socio-Auth-LoginSystem
#### Socio-Auth-LoginSystem is a Complete Build of Laravel 5.6 with Email Registration Verification, Social Authentication, User Roles and Permissions, User Profiles, and Admin restricted user management system. Built on Bootstrap 4.
...
- [Laravel Auth License](#socio-auth-loginSystem-license)
...
1. Run `git clone https://github.com/SavadArakkal84/Socio-Auth-LoginSystem.git laravel-auth`
...
##### Themes Seed List
  * [ThemesTableSeeder](https://github.com/SavadArakkal84/Socio-Auth-LoginSystem/blob/master/database/seeds/ThemesTableSeeder.php)
...
|        | GET|HEAD                               | active-users                          |                                  |  App\Http\Controllers\ProfilesController@upload                                                    | web,auth,activated,currentUser,activity,twostep |
...
|        | GET|HEAD                               | phpinfo                               | laravelPhpInfo::phpinfo          |  App\Http\Controllers\ProfilesController@create                                                    | web,auth,activated,currentUser,activity,twostep |
...
|        | GET|HEAD                               | verification/needed                   | laravel2step::verificationNeeded | 
+--------+----------------------------------------+---------------------------------------+----------------------------------+---------------------------------------------------------------------------------------------------+-------------------------------------------------+
```
...
LARAVEL_2STEP_EMAIL_FROM="savadc2010@gmail.com"
...
* If you have a questions send me an email to savadc2010@gmail.com
* Please be considerate that this is an open source project that I provide to the community for FREE when opening an issue.

Open source projects are a the community’s responsibility to use, contribute, and debug.

### Laravel Auth License
Socio-Auth-LoginSystem is licensed under the [MIT license](https://opensource.org/licenses/MIT). Enjoy!
